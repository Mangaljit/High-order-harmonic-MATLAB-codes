...
folder=fullfile('E:\PhD data\Experimetal Data\Nov 2019 100 Hz\Carbon 12fsec');
cd(folder);
ref_img=fitsread('spectrum2_0001.fts'); 
figure
imshow(ref_img, [100 400]); %[0 500] is just for the contrast management
...
% area(xaxis,img_plot_1st,'LineWidth',4); %multiplied by two to mke it  20 shot spectra
% set(gca, 'YScale', 'log')
% xlim([11.4 49.88])
...
% ylabel('Normalized Intensity (log scale)','FontSize',14,'FontWeight','bold');
