...
% two spectrums, one with linear s-pol with XUV polarizer and other with linear p-pol with XUV polarizer is uploaded.
...
samples=2;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Spectrum for limear s-pol with XUV polarizer
folder=fullfile('D:\PhD data\Experimetal Data\Beamtime 10 Hz Dec2017\carbon1_4dec2017');
cd(folder);
...
for i=1:no_of_images
    ...
    joiname=cat(2,strcat('spectrum1',name,'.fts')); %strcat will place '2' and '265' together as 2265 and cat with 2 also does the same thing
