...
% two spectrums, one with linear s-pol with XUV polarizer and other with linear s-pol without XUV polarizer is uploaded.
...
samples=8;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Spectrum for limear s-pol without XUV polarizer
...
efficiencys=array2./array1;
plot(efficiencys,'o-','Linewidth',3)
% ylim([0 1.1])
%set(gca, 'YScale', 'log')
ylabel('Efficiency for s-pol','Fontsize',16)
