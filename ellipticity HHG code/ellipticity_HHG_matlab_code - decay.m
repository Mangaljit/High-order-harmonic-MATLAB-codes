...
angle_hwp=[2,5,8,15,18,22]; %Angle by which you are rotating the HWP
...
plot(ellipticity,h1./max(h1),ellipticity,h2./max(h2)-0.05,ellipticity,h3./max(h3)-0.1,ellipticity,h4./max(h4)-0.15,'Linewidth',3);
ylim([0 1.1])
